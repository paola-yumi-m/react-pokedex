...
describe('<ShowCard />', function () {
    ...
    it('should render card with info', function () {
        ...
        const pokemons = getPokemons('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/10.png');
        render(
            <ShowCard
                data={pokemons}
                pokemonId={1}
        ...
        expect(imgElement.src).toBe('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/10.png');
